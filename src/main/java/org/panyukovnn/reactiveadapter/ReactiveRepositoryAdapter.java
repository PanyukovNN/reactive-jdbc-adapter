package org.panyukovnn.reactiveadapter;
...
/**
 * Reactive adapter {@link CrudRepository}
 * Do not use Lazy initializing and Transactions with this adapter.
 *
...
public abstract class ReactiveRepositoryAdapter<T, ID> implements ReactiveCrudRepository<T, ID> {

    protected final Scheduler scheduler;
    protected final CrudRepository<T, ID> delegate;
